...
import (
	...
	upcloud-test "github.com/UpCloudLtd/terraform-provider-upcloud/provider" // Import the upstream provider

	"github.com/paketeserrano/pulumi-upcloud-test/provider/pkg/version"
)
...
const (
	...
	mainPkg = "upcloud-test"
	// modules:
	mainMod = "index" // the upcloud-test module
)

//go:embed cmd/pulumi-resource-upcloud-test/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-upcloud-test/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-upcloud-test/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "upcloud-test", upcloud-test.Provider(),
		...
		// convention is to have a function at "github.com/UpCloudLtd/terraform-provider-upcloud/provider".New
		...
		//
		//nolint:lll
		P: shimv2.NewProvider(upcloud-test.New(version.Version)()),
		...
		PluginDownloadURL: "",
		Description:       "A Pulumi package for creating and managing upcloud-test cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"upcloud-test", "category/cloud"},
		License:    "Apache-2.0",
		Homepage:   "https://www.pulumi.com",
		Repository: "https://github.com/paketeserrano/pulumi-upcloud-test",
		...
		Golang: &tfbridge.GolangInfo{
			...
			ImportBasePath: path.Join(
				"github.com/paketeserrano/pulumi-upcloud-test/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("upcloud-test_", mainMod,
